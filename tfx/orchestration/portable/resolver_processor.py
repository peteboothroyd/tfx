...
from tfx.dsl.experimental import oldest_artifacts_resolver
from tfx.dsl.experimental import unprocessed_artifacts_resolver
...
_OldestArtifactsResolver = oldest_artifacts_resolver.OldestArtifactsResolver
_UnprocessedArtifactsResolver = (unprocessed_artifacts_resolver
...
class ResolverProcessorFactory:
  ...
  def from_resolver_config(
    ...
    elif resolver_policy == _ResolverConfig.LATEST_UNPROCESSED_ARTIFACT:
      resolvers = [_UnprocessedArtifactsResolver(),
                   _LatestArtifactsResolver()]
    elif resolver_policy == _ResolverConfig.OLDEST_UNPROCESSED_ARTIFACT:
      resolvers = [_UnprocessedArtifactsResolver(),
                   _OldestArtifactsResolver()]
    else:
