...
class CloudAIBulkInferrerComponent(base_component.BaseComponent):
  ...
  def __init__(
      ...
      output_example: Optional[types.Channel] = None,
    ...
    Args:
      ...
      output_example: Channel of type `standard_artifacts.Examples`
    ...
    if output_example_spec:
      output_example = output_example or types.Channel(
      ...
      if output_example is not None:
        raise ValueError(
            'Must not specify output_example when output_example_spec is unset.'
        )
    ...
    spec = CloudAIBulkInferrerComponentSpec(
        ...
        output_example_spec=(output_example_spec or
